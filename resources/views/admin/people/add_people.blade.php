                    ...
                    <div class="flex flex-col gap-5">
                        ...
                        <div class="flex items-center gap-5">
                            ...
                            <div class="flex gap-[10px] items-center">
                                ...
                                <p class="font-semibold">{{ count($people) }} people</p>
                            </div>
                        </div>
                    </div>
                </div>
            </div>
            <form action="{{ route('dashboard.course.people.store', $course) }}" method="POST" id="add-question" class="mx-[70px] mt-[30px] flex flex-col gap-5">
                @csrf
                <h2 class="font-bold text-2xl">Add New People</h2>
