        ...
        <div id="menu-content" class="flex flex-col w-full pb-[30px]">
            ...
            <div class="flex flex-col gap-10 px-5 mt-5">
                <div class="breadcrumb flex items-center gap-[30px]">
                    ...
                    <a href="{{ route('dashboard.job.edit', $job) }}" class="text-[#7F8190] last:text-[#0A090B] last:font-semibold">Manage Job</a>
                    <span class="text-[#7F8190] last:text-[#0A090B]">/</span>
            ...
            <form method="POST" enctype="multipart/form-data" action="{{ route('dashboard.job.update', $job) }}" class="flex flex-col gap-[30px] w-[500px] mx-[70px] mt-10">
                @csrf
                @method('PUT')
                ...
                <div class="group/division flex flex-col gap-[10px]">
                    ...
                    <div class="peer flex items-center p-[12px_16px] rounded-full border border-[#EEEEEE] transition-all duration-300 focus-within:border-2 focus-within:border-[#0A090B]">
                        ...
                        <select id="division" class="pl-1 font-semibold focus:outline-none w-full text-[#0A090B] invalid:text-[#7F8190] invalid:font-normal appearance-none bg-[url('{{asset('images/icons/arrow-down.svg')}}')] bg-no-repeat bg-right" name="div_id" required>
                            <option value="{{ $job->division->div_id }}" selected>{{ $job->division->div_name }}</option>
                ...
                <div class="group/dept flex flex-col gap-[10px]">
                    <p class="font-semibold">Department</p>
                    <div class="peer flex items-center p-[12px_16px] rounded-full border border-[#EEEEEE] transition-all duration-300 focus-within:border-2 focus-within:border-[#0A090B]">
                        <div class="mr-[10px] w-6 h-6 flex items-center justify-center overflow-hidden">
                            <img src="{{asset('images/icons/bill.svg')}}" class="w-full h-full object-contain" alt="icon">
                        </div>
                        <select id="dept" class="pl-1 font-semibold focus:outline-none w-full text-[#0A090B] invalid:text-[#7F8190] invalid:font-normal appearance-none bg-[url('{{asset('images/icons/arrow-down.svg')}}')] bg-no-repeat bg-right" name="dept_id" required>
                            <option value="{{ $job->dept->dept_id }}" selected>{{ $job->dept->dept_name }}</option>
                            @forelse($depts as $dept)
                            <option value="{{ $dept->dept_id }}" class="font-semibold">{{ $dept->dept_name }}</option>
                            @empty
                            @endforelse
                        </select>
                    </div>
                ...
                <div class="group/jobtype flex flex-col gap-[10px]">
                    ...
                    <div class="peer flex items-center p-[12px_16px] rounded-full border border-[#EEEEEE] transition-all duration-300 focus-within:border-2 focus-within:border-[#0A090B]">
                        ...
                        <select id="jobtype" class="pl-1 font-semibold focus:outline-none w-full text-[#0A090B] invalid:text-[#7F8190] invalid:font-normal appearance-none bg-[url('{{asset('images/icons/arrow-down.svg')}}')] bg-no-repeat bg-right" name="type_id" required>
                            <option value="{{ $job->jobtype->jobtype_id }}" selected>{{ $job->jobtype->jobtype_name }}</option>
                ...
                <div class="group/joblevel flex flex-col gap-[10px]">
                    ...
                    <div class="peer flex items-center p-[12px_16px] rounded-full border border-[#EEEEEE] transition-all duration-300 focus-within:border-2 focus-within:border-[#0A090B]">
                        ...
                        <select id="joblevel" class="pl-1 font-semibold focus:outline-none w-full text-[#0A090B] invalid:text-[#7F8190] invalid:font-normal appearance-none bg-[url('{{asset('images/icons/arrow-down.svg')}}')] bg-no-repeat bg-right" name="level_id" required>
                            <option value="{{ $job->joblevel->joblevel_id }}" selected>{{ $job->joblevel->joblevel_name }}</option>
                ...
                <div class="group/status flex flex-col gap-[10px]">
                    <p class="font-semibold">Status Job</p>
                    <div class="peer flex items-center p-[12px_16px] rounded-full border border-[#EEEEEE] transition-all duration-300 focus-within:border-2 focus-within:border-[#0A090B]">
                        <div class="mr-[10px] w-6 h-6 flex items-center justify-center overflow-hidden">
                            <img src="{{asset('images/icons/security-user.svg')}}" class="w-full h-full object-contain" alt="icon">
                        </div>
                        <select id="status" class="pl-1 font-semibold focus:outline-none w-full text-[#0A090B] invalid:text-[#7F8190] invalid:font-normal appearance-none bg-[url('{{asset('images/icons/arrow-down.svg')}}')] bg-no-repeat bg-right" name="status_job" required>
                            <option value="{{ $job->status_job }}" selected >{{ $job->status_job }}</option>
                            <option value="Aktif" class="font-semibold">Aktif</option>
                            <option value="Ditutup" class="font-semibold">Ditutup</option>
                        </select>
                    </div>
                </div>
