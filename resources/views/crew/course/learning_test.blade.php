...
<body class="font-poppins text-[#0A090B]">
    <section id="content">
        ...
        <form method="POST" action="{{ route ('dashboard.learning.course.answer.store', ['course' => $course->course_id, 'question' => $question->question_id]) }}" class="learning flex flex-col gap-[50px] items-center mt-[50px] w-full pb-[30px]">
            @csrf
