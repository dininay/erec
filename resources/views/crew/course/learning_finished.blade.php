...
<body class="font-poppins text-[#0A090B]">
    <section id="content">
            ...
            <div class="nav flex items-center w-full h-[92px] max-w-[1280px] mx-auto justify-between p-5">
                <div class="flex items-center gap-4">
                    ...
                    <div class="flex flex-col gap-[2px]">
                        ...
                        <p class="text-[#7F8190] text-sm">{{ $course->category->cat_name }}</p>
                    </div>
                </div>
        ...
        <div class="finished flex flex-col gap-[40px] items-center justify-center mt-[120px] mb-[30px] w-full">
            ...
            <a href="{{ route('dashboard.learning.index') }}" class="w-fit p-[14px_30px] bg-[#6436F1] rounded-full font-bold text-sm text-white transition-all duration-300 hover:shadow-[0_4px_15px_0_#6436F14D] text-center align-middle">Back</a>
        </div>
    </section>
